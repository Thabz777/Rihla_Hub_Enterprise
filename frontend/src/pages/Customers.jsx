          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center gap-2 mt-8">
              <button
                ...
                className="px-4 py-2 bg-secondary text-foreground hover:bg-secondary/80 rounded-lg font-heading font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  if (
                    ...
                    return (
                      <button
                        ...
                        className={`w-10 h-10 rounded-lg font-heading font-medium transition-all duration-200 ${

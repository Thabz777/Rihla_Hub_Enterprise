...
const BRANDS = [
    { id: 'b1', name: 'Rihla Technologies', logo: '/brands/tech.png' },
    { id: 'b2', name: 'Rihla Brand Journey', logo: '/brands/journey.png' },
    { id: 'b3', name: 'Rihla Abaya', logo: '/brands/abaya.png' },
    { id: 'b4', name: 'Rihla Atelier', logo: '/brands/atelier.png' }
];
...
app.post('/api/auth/login', (req, res) => {
    ...
    // Normalize
    const u = USERS.find(u => u.email === (email?.trim().toLowerCase()) && u.password === (password?.trim()));
    if (u) {
        return res.json({ access_token: `mock_token_${u.id}`, user: u });
    }
